...
Sia $(G,\star)$ un gruppo. Allora esiste una mappa iniettiva $\Phi(G,\star)\longrightarrow(S(G),\odot)$ che preserva le operazioni, cioè $\Phi (a*b)=\Phi(a)*\Phi(b)$
### Gli Anelli
...
Sia $(G,*)$ un gruppo. Allora esiste una mappa iniettiva $\Phi(G,*)\longrightarrow(S(G),\circ)$ che preserva le operazioni, cioè $\Phi (a*b)=\Phi(a)*\Phi(b)$
