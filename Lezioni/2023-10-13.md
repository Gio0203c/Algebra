...
Notiamo quindi che se $n$ non è un numero primo, allora solo i numeri coprimi con esso saranno invertibili. Ma quanti sono gli elementi invertibili? Per scoprirlo, occorre utilizzare la [[funzione φ di Eulero]].
# TODO
