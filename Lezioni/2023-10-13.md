...
Notiamo quindi che se $n$ non è un numero primo, allora solo i numeri coprimi con esso saranno invertibili. Ma quanti sono gli elementi coprimi con $n$? Per scoprirlo, occorre utilizzare la [[funzione φ di Eulero]].
# TODO
- Collegare alla funzione $\varphi$ di Eulero
