...
###### Definizione - Anello di Divisione
...
$$\begin{align}&\begin{cases}ad=bc \\ cf=de,\end{cases}\implies\begin{cases}adf=bcf \\ bcf=bde\end{cases}\\ \implies &adf=bde\implies af=be\implies(a,b)\space\rho\space(e,f) \end{align} $$
