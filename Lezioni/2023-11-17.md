...
- Consideriamo la prima colonna di $A.$ Se contiene solo zeri, poniamo $p_{1}=0$ e passiamo alla seconda colonna. Se invece contiene qualche elemento non nullo, scambiamo se necessario la prima equazione con una delle successive in modo che a essere diverso da zero sia $a_{11}.$
